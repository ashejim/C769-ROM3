...
**Task 2 — The Proposal:** {{ task2_example }} — a single example that most closely follows the current Task 2 template. (Its topic differs from the Task 1/Task 3 sets below.)

The Task 1 and Task 3 examples below are grouped into complete capstones by topic:
...
Complete the [approval form](https://ashejim.github.io/C769-ROM3/task1_ROM3.html#topic-approval) and submit it directly to Assessments as your Task 1. Your course instructor (or, in the future, an evaluator) will pass it or return it with comments for revision — there is no email-to-instructor or signature step. Afterward, you can start working on Task 2. Questions? It’s why we’re here. Contact us by email (fastest) or live appointment (best for general discussions). Here you can find all [C769 CI's contact information](https://ashejim.github.io/C769-ROM3/ci_page.html#course-faculty).
```
...
|----------------|-------------------------------|-----------------------------|
| Week 1 | Days 2-3 | Fill out the <a href="https://ashejim.github.io/C769-ROM3/task1_ROM3.html#topic-approval">Task 1 Template</a> following the steps in the <a href="https://ashejim.github.io/C769-ROM3/task1_ROM3.html">Task 1 Guide</a>. Review the <a href="https://ashejim.github.io/C769-ROM3/resources_ROM3.html#examples">Task 1 examples</a>.<ol><li>Watch the <a href="https://ashejim.github.io/C769-ROM3/intro_ROM3.html#start-here"> welcome video</a>. Having trouble picking a topic? See <a href="https://ashejim.github.io/C769-ROM3/task1_ROM3.html#choosing-a-topic">Choosing a Topic</a> and <a href="https://ashejim.github.io/C769-ROM3/ci_page.html">contact your course intructor</a>.</li><li>Submit your completed topic approval form directly to Assessments as your Task 1. Details can be changed in Task 2 — we only need a draft including these <a href="https://ashejim.github.io/C769-ROM3/task1_ROM3.html#choosing-a-topic">key items</a>.</li><li>Your course instructor will pass it or return it with comments; either way, get started on the next step! The <a href="https://ashejim.github.io/C769-ROM3/task1_ROM3.html#restricted-information-authorization-form">Restricted Information Authorization Form</a> can often be omitted.</li></ol>|
